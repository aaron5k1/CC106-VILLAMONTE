...
import { Search, ArrowRight, Zap, Shield, Users, BookOpen, Globe, Twitter, Instagram, User, Home, LogIn, UserPlus, LayoutDashboard } from 'lucide-react';
import { motion } from 'framer-motion';
export default function LandingView() {
    return (<div className="bg-[#F8FAFC] min-h-screen text-[#1E293B]">
      {/* Top Navigation */}
      <nav className="h-20 bg-white/80 backdrop-blur-md sticky top-0 z-50 border-b border-slate-100 px-4 sm:px-8 flex items-center justify-between">
        ...
        <div className="flex items-center gap-6">
          <div className="relative group hidden sm:block">
            ...
            <input type="text" placeholder="Search the collection..." className="pl-10 pr-4 py-2 bg-slate-50 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#1E3A8A]/10 w-64"/>
          </div>
      ...
      <section className="max-w-[1400px] mx-auto px-4 sm:px-8 py-10 sm:py-20 lg:py-32 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="relative pt-10 lg:pt-0">
          <div className="aspect-[4/5] rounded-3xl overflow-hidden shadow-2xl shadow-slate-300">
            <img src="https://images.unsplash.com/photo-1549675584-91f19337af3d?auto=format&fit=crop&q=80&w=1200" alt="Grand Library" className="w-full h-full object-cover"/>
          </div>
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-8 space-y-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 relative aspect-[16/10] sm:aspect-[16/10] rounded-3xl overflow-hidden group">
              <img src="https://images.unsplash.com/photo-1507842217343-583bb7270b66?auto=format&fit=crop&q=80&w=1400" alt="Exhibition" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700"/>
            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="flex-1 relative rounded-3xl overflow-hidden group">
                <img src="https://images.unsplash.com/photo-1481627834876-b7833e8f5570?auto=format&fit=crop&q=80&w=800" alt="Microfilm" className="w-full h-full object-cover"/>
      ...
      <section className="max-w-[1400px] mx-auto px-8 py-32 space-y-24">
        ...
        ].map((item, i) => (<div key={i} className="flex gap-8 group">
      ...
      <section className="max-w-[1400px] mx-auto px-4 sm:px-8 mb-32">
        <div className="bg-[#0F172A] rounded-[2rem] sm:rounded-[3rem] overflow-hidden grid grid-cols-1 lg:grid-cols-2 items-center">
          ...
          <div className="h-full min-h-[300px] sm:min-h-[400px]">
             <img src="https://images.unsplash.com/photo-1524995997946-a1c2e315a42f?auto=format&fit=crop&q=80&w=1200" alt="Antique Books" className="w-full h-full object-cover"/>
          </div>
        </div>
      </section>
      ...
      <footer className="border-t border-slate-100 pt-20 pb-10 bg-white">
        ...
        ].map((col) => (<div key={col.title} className="space-y-6">
                <h6 className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#1E293B]">{col.title}</h6>
                <ul className="space-y-4 text-sm text-slate-500 font-medium">
                  {col.links.map(l => (<li key={l}><a href="#" className="hover:text-[#2563EB] transition-colors">{l}</a></li>))}
                </ul>
              </div>))}
          </div>
